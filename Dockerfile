...
ADD C:\\Windows\\System3\\config\\systemprofile\\AppData\Local\Jenkins\.jenkins\workspace\test-swagger1\target\swagger-demo-0.0.1-SNAPSHOT.jar /opt/titan/APPLICATION.jar
EXPOSE 8081
